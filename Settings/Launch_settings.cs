...
namespace Settings
{
   public class Launch_settings
   {
      ...
      /// <summary>
      /// Test if the HTTP/HTTPS protocol request is OK, and whether HTTPS should be enforced.
      /// Note that "Required" means that the protocol must be usable.
      /// </summary>
      /// <param name="http_status">Is HTTP Banned, Allowed or Required.</param>
      /// <param name="https_status">Is HTTPS Banned, Allowed or Required.</param>
      /// <param name="are_exclusive">Only used when the protocols can be referenced together.</param>
      /// <returns></returns>
      /// <exception cref="Exception"></exception>
