...
--
-- Host: 127.0.0.1    Database: ELIAS_QS_WorkDB
-- ------------------------------------------------------
...
INSERT INTO `new_table` VALUES (1,'2024-04-18',18),(2,'2024-04-19',19),(3,'2024-04-20',20),(4,'2024-04-21',21),(5,'2024-04-22',22),(6,'2024-04-23',23),(7,'2024-04-24',24),(8,'2024-04-25',25),(9,'2024-04-17',17);
/*!40000 ALTER TABLE `new_table` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'ELIAS_QS_WorkDB'
--

--
-- Dumping routines for database 'ELIAS_QS_WorkDB'
--
...
/*!50003 DROP PROCEDURE IF EXISTS `Get_date_temperature` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Insert_temperature` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2024-05-19 19:42:09
