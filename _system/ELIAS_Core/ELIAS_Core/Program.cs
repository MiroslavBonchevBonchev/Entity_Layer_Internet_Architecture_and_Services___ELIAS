...
using Data_Access;
using ELIAS_Core.Services;
using Microsoft.AspNetCore.Components.Authorization;
using Microsoft.AspNetCore.Identity;
using Microsoft.EntityFrameworkCore;
using ELIAS_Core.Client.Pages;
using ELIAS_Core.Components;
using ELIAS_Core.Components.Account;
using ELIAS_Core.Data;
using Microsoft.Extensions.Options;
using Swashbuckle.AspNetCore.SwaggerGen;
using ELIAS_Core.Swagger;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies( typeof( ELIAS_Core.Client._Imports ).Assembly );
